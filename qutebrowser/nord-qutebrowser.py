...
# ## Type: String
c.colors.prompts.border = '2px solid ' + nord['nord8']
...
## Type: QssColor
c.colors.statusbar.caret.fg = nord['nord4']
...
## Type: QssColor
c.colors.statusbar.caret.selection.fg = nord['nord4']
...
## Type: QssColor
c.colors.statusbar.passthrough.fg = nord['nord4']
...
## Type: QssColor
c.colors.statusbar.private.fg = nord['nord4']

## Background color of the progress bar.
## Type: QssColor
c.colors.statusbar.progress.bg = nord['nord4']
...
## (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = nord['nord11']

## Foreground color of the URL in the statusbar on successful load
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = nord['nord7']
...
# ## Type: QtColor
c.colors.tabs.selected.even.bg = nord['nord9']
...
# ## Type: QtColor
c.colors.tabs.selected.odd.bg = nord['nord9']
