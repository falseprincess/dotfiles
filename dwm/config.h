...
static const char *fonts[]          = { "Terminus:size=8", "FontAwesome:pixelsize=14:antialias=true" };
...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { col_gray4, col_cyan,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
        ...
        [SchemeInfoSel]  = { col_gray4, col_teal,  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
        [SchemeInfoNorm]  = { col_gray3, col_gray1,  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
};

/* tagging */
static const char *tags[] = { "WEB", "TERM", "CHAT", "MEDIA", "GFX", "VBOX" };
...
static char *editsrc_cmd[] = { "emacs", "~/.dwm/dwm.c", NULL };
static char *editdwm_cmd[] = { "emacs", "~/.dwm/config.h", NULL };
static char dmenumon[2] = "0"; /* component of dmenucmd, manipulated in spawn() */
static const char *killcmd[] = { "xdotool", "getactivewindow", "windowkill", NULL, };
static char *editor_cmd[] = { "emacs", NULL }; /* setting my prefered terminal emulator */
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray4, "-sb", col_blue, "-sf", col_gray4, "-h", "20", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
        { MODKEY,                       XK_Return, spawn,          {.v = alttermcmd } },
	{ MODKEY|ControlMask,           XK_e,      spawn,          {.v = editor_cmd } },
        { MODKEY|ControlMask,           XK_1,      spawn,          {.v = editdwm_cmd } },
	{ MODKEY|ControlMask,           XK_2,      spawn,          {.v = editsrc_cmd } },
	...
	{ MODKEY|ControlMask,           XK_d,      spawn,          CMD("./Discord/Discord") },
	{ MODKEY|ControlMask,           XK_b,      spawn,          CMD("firefox-beta") },
	{ MODKEY|ControlMask,           XK_n,      spawn,          CMD("nitrogen") },
	{ MODKEY|ControlMask,           XK_p,      spawn,          CMD("pavucontrol") },
	{ MODKEY|ControlMask,           XK_f,      spawn,          CMD("nemo") },
