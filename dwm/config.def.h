...
static const int user_bh            = 0;        /* 0 means that dwm will calculate height, 1 means dwm will user_bh as height */
static const char *fonts[]          = { "dina:size=8", "FontAwesome:size=16" };
...
static const char *colors[][3]      = {
  ...
  [SchemeSel]  =  { col_white, col_gray1,   col_white }, // Window border focus
  [SchemeStatus]  =  { col_black, "#81A1C1",  "#000000"  }, // Statusbar right 
  [SchemeTagsSel]  =  { col_cyan, col_black,  "#000000"  }, // Tagbar left selected
  [SchemeTagsNorm]  =  { col_gray3, col_black,  "#000000"  }, // Tagbar left unselected
  [SchemeInfoSel]  =  { col_teal, col_black,  "#000000"  }, // infobar middle selected 
  [SchemeInfoNorm]  =  { col_black, col_black,  "#000000"  }, // infobar middle unselected 
  };
...
/* tagging */ 
static const char *tags[] = { "TERM", "WEB", "CHAT", "DEV", "MEDIA", "GFX", "VIRT", "MISC" };
...
static const Rule rules[] = {
	...
	{ "Virtual Machine Manager", NULL, 		NULL, 						 0, 					 1, 				-1 },
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_e,      spawn,          CMD(TERMINAL " -e vim") },

	/* Volume */
	{ 0,                            XK_F3, spawn, CMD("amixer set Master 5%+") },
 	{ 0,                            XK_F2, spawn, CMD("amixer set Master 5%-") },
	{ 0,                            XK_F1, spawn, CMD("amixer set Master toggle") },

	/* Brightness */
	{ 0,                            XK_F6, spawn, CMD("brightnessctl s 5%+") },
	{ 0,                            XK_F5, spawn, CMD("brightnessctl s 5%-") },
  ...
  { MODKEY|ControlMask,           XK_u,      spawn,          CMD(TERMINAL " -e unimatrix -c blue -n -s 92 -u 'Void'") },
	...
	{ MODKEY|ControlMask,           XK_b,      spawn,          CMD("librewolf") },
