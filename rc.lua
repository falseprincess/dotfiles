...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " www ", " term ", " vbox ", " chat ", " media " }
...
awful.util.mymainmenu = freedesktop.menu.build({
    icon_size = beautiful.menu_height or 0,
    before = {
...
globalkeys = my_table.join(
    ...
    function ()
        awful.spawn(string.format("dmenu_run -h 22 -nb '#434C5E' -nf '#D8DEE9' -sb '#81A1C1' -sf '#D8DEE9'",
    ...
    function ()
        awful.spawn(string.format("betterlockscreen -l",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "run betterlocksreen", group = "hotkeys"}),

    -- firefox
    awful.key({ modkey, }, "b",
    function ()
        awful.spawn(string.format("firefox-beta",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show firefox-beta", group = "hotkeys"}),

    -- discord
    awful.key({ modkey, "Shift" }, "d",
    function ()
        awful.spawn(string.format("flatpak run com.discordapp.Discord",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show discord", group = "hotkeys"}),

    -- spotify
    awful.key({ modkey, "Shift" }, "s",
    function ()
        awful.spawn(string.format("flatpak run com.spotify.Client",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show spotify", group = "hotkeys"}),
    ...
    {description = "show pavucontrol", group = "hotkeys"}),
    ...
    {description = "show pcmanfm", group = "hotkeys"}),

    -- gedit
    awful.key({ modkey, "Shift" }, "g",
    function ()
        awful.spawn(string.format("gedit",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show gedit", group = "hotkeys"}),

    -- xfce4-taskmanager
    awful.key({ modkey, "Shift" }, "t",
    function ()
        awful.spawn(string.format("xfce4-taskmanager",
        beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
    {description = "show xfce4-taskmanager", group = "hotkeys"}),

    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn( "gnome-screenshot -i" ) end,
        {description = "gnome-screenshot gtk-popup", group = "screenshots"}),
   ...
   -- Brightness
    ...
    awful.key({ modkey, "Shift"           }, "m", function () awful.util.mymainmenu:show() end,
    ...
    awful.key({ modkey, "Shift"   }, "q",  function () awful.spawn.with_shell( 'killall awesome' ) end,
              {description = "killall awesome", group = "awesome"}),
...
awful.spawn.with_shell("accountable2you")
